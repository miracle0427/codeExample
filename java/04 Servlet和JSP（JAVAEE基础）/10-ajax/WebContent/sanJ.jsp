...
<script type="text/javascript">
	//创建函数获取所有的省信息
		...
		//使用ajax请求所有的省信息
			myAjax("get","data","pid=0",function(ajax){
				//获取响应数据
				...
				//处理响应数据
					...
					for(var i=0;i<areas.length;i++){
						sel.innerHTML=sel.innerHTML+"<option value="+areas[i].areaid+">"+areas[i].areaname+"</option>"
					}
					getCity();
			});
	...
	//获取所有的市信息
		function getCity(){
		 	...
		 	myAjax("get","data","pid="+pid, function(ajax){
		 		//获取响应数据
				var result=ajax.responseText;
				eval("var areas="+result);
				//获取下拉框对象
